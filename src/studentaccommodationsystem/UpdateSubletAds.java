 ...
 * @author taome
 */
public class UpdateSubletAds extends javax.swing.JFrame {

    /**
     * Creates new form UpdateSubletAds
     */
    ...
    public UpdateSubletAds() {
        initComponents();
    }
    
    public UpdateSubletAds(String email, String name, String id) {
        initComponents();
        hemail = email;
        hname = name;
        sid = id;
    ...
    public void getSubletDetails()
    {
        try{
            String sql="Select * from subletdetails where subletid='"+sid+"' ;";
            byte[] image;
    ...
    private void initComponents() {
        ...
        jPanel1.setPreferredSize(new java.awt.Dimension(635, 750));
        ...
        jLabel8.setText("SubLet Details");
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                        .addGroup(jPanel1Layout.createSequentialGroup()
                            ...
                            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                            .addComponent(sfacility, javax.swing.GroupLayout.PREFERRED_SIZE, 365, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        ...
        try{
            String sql="Delete from subletdetails where subletid='"+sid+"' ;";
    ...
    private void updateButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateButtonActionPerformed
        ...
        try{
            String sql="Update subletdetails set rent = '" +ren+ "' where subletid='"+sid+"' ;";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UpdateSubletAds.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UpdateSubletAds().setVisible(true);
            }
        });
    }
